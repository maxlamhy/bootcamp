...
public class DemoBigDecimal {
  public static void main(String[] args) {
    ...
    double y = 0.15;
    System.out.println(
        BigDecimal.valueOf(x).multiply(BigDecimal.valueOf(y)).doubleValue()); // 0.0376845
    ...
    // Divide
    // / zero
    // non-terminated decimal places (i.e. 3.33333)
    System.out.println(
    ...
    // System.out.println(BigDecimal.valueOf(10).divide(BigDecimal.valueOf(3)).doubleValue()); //
    ...
    int quantity = 3;
    double price = 99.9; // Java store 99.89999999999999147348748730170726776123046875
